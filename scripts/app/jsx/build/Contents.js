        ...
        return (
            React.createElement("table", {className: "table table-hover"}, 
                ...
                React.createElement("tr", null, 
                    React.createElement("th", {className: "col-sm-1"}, "栏目"), 
                    React.createElement("th", {className: "col-sm-4"}, "标题"), 
                    React.createElement("th", {className: "col-sm-1"}, "类型"), 
                    React.createElement("th", {className: "col-sm-1"}, "状态"), 
                    React.createElement("th", {className: "col-sm-1"}, "发布者"), 
                    React.createElement("th", {className: "col-sm-2"}, "发布时间"), 
                    React.createElement("th", {className: "col-sm-2"}, "更新时间")
                )
                ), 
